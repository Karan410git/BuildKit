...
def register_user(payload: UserRegisterRequest, db: Session = Depends(get_session)) -> User:
...
def login_user(payload: UserLoginRequest, db: Session = Depends(get_session)) -> TokenResponse:
